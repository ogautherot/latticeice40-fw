...
#pragma GCC warning "Temp sensor"
...
#define CT16B0 ((Ct16bStruct *)CT16B0_BASE)
#define CT16B1 ((Ct16bStruct *)CT16B1_BASE)
...
#define CT32B0 ((Ct32bStruct *)CT32B0_BASE)
#define CT32B1 ((Ct32bStruct *)CT32B1_BASE)
...
#define DMA_TRIGMUX ((DmaTrigMuxStruct *)DMA_TRIGMUX_BASE)
...
typedef struct SysConStruct
{
  ...
  uint32_t Reserved15[220]; // 0x23c

  uint32_t : 32;         // 0x3f0
  __O uint32_t DeviceId; // 0x3f4
} SysConStruct;
...
#define UART0 ((Usart0Struct *)USART0_BASE)
...
#define UART3 ((UsartStruct *)USART3_BASE)
#define UART4 ((UsartStruct *)USART4_BASE)
...
#define SCT0 ((SctStruct *)SCT0_BASE)
#define SCT1 ((SctStruct *)SCT1_BASE)
...
#define GPIO_GRP0_BASE ((GpioGrpStruct *)GPIO_GRP0_BASE)
